...
async def main():
    ...
    config_table.add_row("Observer Utility Model", settings.observer_utility_model)
    config_table.add_row("Observer Extraction Model", settings.observer_extraction_model)
